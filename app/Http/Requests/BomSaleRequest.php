...
class BomSaleRequest extends FormRequest
{
    /**
    ...
    public function messages()
    {
        ...
        {
            $k = $key+1;
            $messages['items.'.$key.'.name.required'] = 'Name for item '.$k.' is required';
            ...
            $messages['items.'.$key.'.name.string'] = 'Name for item '.$k.' must be string';
