...
Route::get('/show/password/page', [App\Http\Controllers\UserController::class, 'showPasswordPage'])->name('show.password.page');

Route::post('/password/store', [App\Http\Controllers\UserController::class, 'passwordStore'])->name('password.store');


Route::get('/logged_in_user', [App\Http\Controllers\UserController::class, 'logged_in_user'])->name('logged_in_user');
Route::get('/bills/download-bills/', [App\Http\Controllers\BillController::class, 'downloadBillsInPdf']);
